...
RUN pip --no-cache-dir install --upgrade \
        http://download.pytorch.org/whl/cu102/torch-1.7.1-cp37-cp37m-linux_x86_64.whl \
        http://download.pytorch.org/whl/cu102/torchvision-0.8.2-cp37-cp37m-linux_x86_64.whl \
        torchtext==0.8.1 \
        tensorboardX==2.1 \
        fastai \
        transformers \
